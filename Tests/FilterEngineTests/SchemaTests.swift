...
final class SchemaTests: XCTestCase {
    ...
    func testSchemaVersion() throws {
        ...
        // Compare the files
        XCTAssertEqual(tempRulesData, referenceRulesData, "Rules file content has changed. Update reference-rules.bin and increment Schema.VERSION.")
        XCTAssertEqual(tempEngineData, referenceEngineData, "Engine file content has changed. Update reference-engine.bin and increment Schema.VERSION.")
    }
}
