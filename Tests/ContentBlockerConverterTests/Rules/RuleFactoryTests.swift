...
final class RuleFactoryTests: XCTestCase {
    ...
    func testFilterOutRules() {
        ...
        let testCases: [TestCase] = [
            ...
            TestCase(
                // Issue #120: www.google.* + google.com exception.
                // The exception domain "google.com" must be added to
                // restrictedDomains because resolved "www.google.com"
                // is a subdomain of "google.com".
                name: "negate wildcard subdomain with www prefix",
                rules: [
                ...
                expectedRules: [
                    ExpectedRule(
                        cosmeticContent: ".cu-container",
                        permittedDomains: ["www.google.*"],
                        restrictedDomains: ["google.com"]
                    )
                ],
                expectedErrorsCount: 0,
                version: SafariVersion.safari16_4
            ...
            TestCase(
                // Without www prefix should also work (existing behavior).
                name: "negate wildcard domain without www prefix",
                rules: [
                    "google.*##.cu-container",
                    "google.com#@#.cu-container",
                ],
            ...
            TestCase(
                // Sub-subdomain wildcard + parent exception.
                name: "negate deep wildcard subdomain",
                rules: [
                    "sub.example.*##.ad",
                    "example.com#@#.ad",
                ],
            ...
            TestCase(
                // Unrelated domain exception must NOT restrict.
                name: "unrelated exception does not restrict wildcard",
                rules: [
                    "example.*##.ad",
                    "other.com#@#.ad",
                ],
