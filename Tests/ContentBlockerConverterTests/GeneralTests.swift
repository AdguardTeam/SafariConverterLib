...
//    errors:
//    "Error converting rule from: ||videoplaza.tv^$object-subrequest,third-party,domain=tv4play.se cause:
//    Error: $object content type is not yet supported
//    "
    
//    "Error converting rule from: @@/^https?://(?!(qs.ivwbox.de|qs.ioam.de|platform.twitter.com|connect.facebook.net|de.ioam.de|pubads.g.doubleclick.net|stats.wordpress.com|www.google-analytics.com|www.googletagservices.com|apis.google.com|script.ioam.de)/)/$script,third-party,domain=gamona.de cause:
//    Error: Safari doesn't support '|' in regular expressions
//    "
    
//    "Error converting rule from: /.filenuke.com/.*[a-zA-Z0-9]{4}/$script cause:
//    Error: Safari doesn't support '{digit}' in regular expressions
//    "
    
    
//    2020-08-28 17:25:45.198362+0200 xctest[4862:66413] /addyn|*|adtech;
//    2020-08-28 17:25:45.199133+0200 xctest[4862:66413] Unexpected error: unsupportedRegExp(message: "Safari doesn\'t support \'|\' in regular expressions").
